                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tbody v-for='(item, key) in formsData'>
                            <tr>
                                ...
                                <td><router-link :to="{path:'/ladybird_cms/supervise-form-detail',query:{id:item.form_id}}">
...
select: function(e) {
    ...
    _this.length = 0;
    _this.arr = [];
    this.axios.get(_global.baseUrl + 'allPassForm?page=1&college='+_this.teacher_college).then(body => {
